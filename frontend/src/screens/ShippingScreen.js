...
function ShippingScreen(props) {
    ...
    const submitHandler = (e) => {
      e.preventDefault();
      dispatch(saveShipping({ address, city, postalCode, country, contact }));
        ...
        <form onSubmit={submitHandler} >
          <ul className="form-container">
            ...
            <li>
              ...
              <input type="text" name="contact" id="contact" onChange={(e) => setContact(e.target.value)} required maxLength='10'>
              </input>
            </li>
            <li>
